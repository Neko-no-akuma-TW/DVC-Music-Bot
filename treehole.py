...
class Treehole(commands.Cog): 
    ...
    async def _automatically_check_tree_hole(self):
        channel = await self.bot.fetch_channel(1505202112529694751)
        ...
        new_channel = await self.bot.fetch_channel(1505202112529694751)
